...
\usepackage[
    title={Agile Requirements Engineering in Product Development},
    author={Suresh Muthuveerappan},
    type=master,
    institute=iris,
    course=cs,
    examiner={Univ-Prof. Hon-Prof. Dr. Dieter Roller},
    supervisor={Dipl.-Inf. Akram Chamakh},
    startdate={April 18, 2017}, % English: July 5, 2013;    ISO: 2013-07-05
    enddate={October 19, 2017}, % English: January 5, 2014; ISO: 2014-01-05
    crk={D.2.5, D.2.2, D.2.1}
