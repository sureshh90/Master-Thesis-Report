...
\begin{figure}[htb!]
  \centering
    \subfloat[]{\includegraphics[width=0.4\textwidth]{content/images/Chapter2/ClassDiagram.png} \label{fig:umldiagrams_subfigA}}
   \subfloat[]{\includegraphics[width=0.4\textwidth]{content/images/Chapter2/ActivityDiagram.png} \label{fig:umldiagrams_subfigB}}
...
\begin{figure}[htb!]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{content/images/Chapter2/Petrinetwithlabels.png}}
...
\begin{figure}[htb!]
  \centering
    \fbox{\includegraphics[width=0.3\textwidth]{content/images/Chapter2/Petrineta.png} \label{fig:petrinet_subfigA}}
   \fbox{\includegraphics[width=0.3\textwidth]{content/images/Chapter2/Petrinetb.png} \label{fig:petrinet_subfigB}}
	\caption{An example of a Petri Net a) before transition b) after transition.}
