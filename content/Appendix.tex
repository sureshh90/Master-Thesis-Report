...
\begin{figure}[htb!]
\centering
\fbox{\includegraphics{content/images/Appendix/figg1}}
...
\begin{figure}[htb!]
\centering
\fbox{\includegraphics{content/images/Appendix/fig2}}
\caption{M2M Rules for transformation from RUCM to Petri Net(2/2)}
